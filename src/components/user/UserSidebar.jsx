    ...
    >
      ...
      <div className="sidebar-brand-bg px-4 py-3.5 flex items-center gap-3 shrink-0">
        <div className="bg-white/15 rounded-xl p-1.5 shrink-0">
          <img
            ...
            alt={`${branding.app_name || USER_BRANDING.appName} Logo`}
        ...
        <div className="min-w-0">
          <span className="text-white font-bold text-sm leading-tight block truncate">
            {branding.app_name || USER_BRANDING.appName}
          </span>
      ...
      <div className="px-3 shrink-0">
        <Link
          ...
          style={location.pathname === '/user/chat' ? { boxShadow: 'inset 3px 0 0 #1D4ED8' } : undefined}
        >
          <svg
            className={`w-4 h-4 shrink-0 ${location.pathname === '/user/chat' ? 'text-blue-500' : 'text-slate-400'}`}
          ...
          <>
            {conversations.map((c) => {
              ...
              return (
                ...
                >
                  <svg
                    className={`w-3.5 h-3.5 shrink-0 ${active ? 'text-blue-500' : 'text-slate-300'}`}
